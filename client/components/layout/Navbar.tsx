  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <a
            ...
            data-cursor="hover"
            className="group inline-flex min-w-11 min-h-11 items-center justify-center"
            aria-label="Home"
          >
            <img
              src={logo}
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                data-cursor="hover"
                className="inline-flex min-h-11 items-center text-text-secondary hover:text-primary transition-colors duration-300 ease-out text-sm font-medium"
              >
                {link.name}
              </a>
            ))}
      ...
      <motion.div
        ...
        className="fixed inset-0 z-30 glass lg:hidden pt-20 overflow-y-auto"
        ...
        <div className="flex flex-col gap-4 p-6">
          {navLinks.map((link, i) => (
            <motion.a
              ...
              className="flex items-center min-h-11 text-text-secondary hover:text-primary transition-colors duration-300 text-lg font-medium"
            >
              {link.name}
            </motion.a>
          ))}
